#!/usr/bin/env node
/**
 * Render Laguz icon PNGs from the SVG source at all required sizes.
...
async function main() {
  console.log('[Laguz icons] Rendering PNGs from SVG...');
  ...
  console.log('[Laguz icons] Generating .icns bundle...');
  await generateIcns();

  console.log('[Laguz icons] Done.');
}
