...
export function AccountsView({ path, entity }: AccountsViewProps) {
  const { meetings, loading: meetingsLoading, refresh: refreshMeetings } = useMeetings(entity);
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      {/* Middle pane: meetings + account docs */}
      ...
      <NoteDetail notePath={selectedPath} onMarkProcessed={refreshMeetings} />
    </div>
  );
}
